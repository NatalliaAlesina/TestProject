...
public class ExtrassPage extends po.pages.BasePage {
    ...
    public ExtrassPage(WebDriver driver) {
        super(driver);
    }
    ...
    public ExtrassPage selectInsurance() {
        ...
        HighlightUtils.highlightElement(selectInsuranceButton);
    ...
    public ExtrassPage openCap() {
        ...
        HighlightUtils.highlightElement(capAddonBox);
        capAddonBox.click();
        return this;
    }
    ...
    public ExtrassPage selectCap() {
        ...
        HighlightUtils.highlightElement(capValue);
        capValue.click();
